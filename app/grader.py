...
def _base_leg_kwargs(leg: Leg, *, input_source_path: str = 'manual_text') -> dict:
    return {
        ...
        'identity_resolution_time_ms': leg.identity_resolution_time_ms,
        'event_resolution_time_ms': leg.event_resolution_time_ms,
        'candidate_player_count': leg.candidate_player_count,
        'candidate_event_count': leg.candidate_event_count,
        'resolution_path_taken': leg.resolution_path_taken,
